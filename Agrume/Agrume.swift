...
public final class Agrume: UIViewController {
  ...
  public convenience init(image: UIImage, backgroundBlurStyle: UIBlurEffectStyle? = .Dark, backgroundSnapshot: UIImage? = nil ) {
    self.init(image: image, imageURL: nil, backgroundBlurStyle: backgroundBlurStyle)
  }
  
  public convenience init(imageURL: NSURL, backgroundBlurStyle: UIBlurEffectStyle? = .Dark, backgroundSnapshot: UIImage? = nil ) {
    self.init(image: nil, imageURL: imageURL, backgroundBlurStyle: backgroundBlurStyle)
  }
  
  public convenience init(dataSource: AgrumeDataSource, startIndex: Int? = nil, backgroundBlurStyle: UIBlurEffectStyle? = .Dark, backgroundSnapshot: UIImage? = nil ) {
    self.init(image: nil, images: nil, dataSource: dataSource, startIndex: startIndex, backgroundBlurStyle: backgroundBlurStyle)
  }
  
  public convenience init(images: [UIImage], startIndex: Int? = nil, backgroundBlurStyle: UIBlurEffectStyle? = .Dark, backgroundSnapshot: UIImage? = nil ) {
    self.init(image: nil, images: images, startIndex: startIndex, backgroundBlurStyle: backgroundBlurStyle)
  }
  
  public convenience init(imageURLs: [NSURL], startIndex: Int? = nil, backgroundBlurStyle: UIBlurEffectStyle? = .Dark, backgroundSnapshot: UIImage? = nil ) {
  ...
  private init(image: UIImage? = nil, imageURL: NSURL? = nil, images: [UIImage]? = nil, dataSource: AgrumeDataSource? = nil,
               imageURLs: [NSURL]? = nil, startIndex: Int? = nil, backgroundBlurStyle: UIBlurEffectStyle? = .Dark, backgroundSnapshot: UIImage? = nil ) {
    self.images = images
    if let image = image {
      self.images = [image]
    }
